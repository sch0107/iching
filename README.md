...
- **三傳（初传、中传、末传）**：使用传统九宗门方法（贼克法、涉害法、遥克法、昴星法等）推算三传
- **四課**：按传统方法从日干寄宫推算四课，结合天盘上神，分析干支关系与五行生克
- **天盤地盤**：采用月将加时法推算天盘旋转，地盘固定十二地支
- **五行分析**：全面分析五行生成与克制关系，判断元素平衡
- **空亡**：根据日干地支在六十甲子中的旬位计算空亡地支，准确判断落空之象
- **局（上局、中局、下局）**：根据日干月支关系确定局势
- **十二将**：完整实现十二天将（贵人、螣蛇、朱雀、六合、勾陈、青龙、天空、白虎、太常、玄武、太阴、天后），依日干及时辰准确排布
- **六亲**：按五行生克关系准确计算（生我者父母，我生者子孙，克我者官鬼，我克者妻财，比和者兄弟）
- **月将（Monthly General）**：据二十四节气准确判定月将（亥将、戌将、酉将等）
- **综合卦象**：基于所有因素计算整体运势（大吉、吉、平、凶、大凶）
- **日占/夜占**：根据时辰区分日间与夜间占卜，贵人位置有不同
